...
while True:
    ...
    if humano_numero < 0 or humano_numero > 10:
        while True:
            print('')
            print('Você não digitou um número no intervalo que combinamos. Tente de novo!')
            time.sleep(1)
            humano_numero = int(input('\033[1mUm, dois, três e já! Digite um número de 0 a 10: \033[m'))
...
print(f'Eu ganhei {contador} vezes! Foi divertido. Até mais!')
